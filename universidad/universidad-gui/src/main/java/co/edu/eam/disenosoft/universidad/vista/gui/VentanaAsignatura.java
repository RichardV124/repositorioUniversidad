...
public class VentanaAsignatura extends javax.swing.JInternalFrame implements ActionListener {
	private ControladorVentanaAsignatura controlador;
	...
	public VentanaAsignatura() {
		initComponents();
		controlador = new ControladorVentanaAsignatura();
		setVisible(true);
										...
										jPanel1Layout.createSequentialGroup().addGap(23, 23, 23)
												...
												.addGroup(jPanel1Layout
														.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING,
																false)
														.addComponent(tfSemestre, javax.swing.GroupLayout.DEFAULT_SIZE,
																268, Short.MAX_VALUE)
														.addGroup(jPanel1Layout
																.createParallelGroup(
																		javax.swing.GroupLayout.Alignment.LEADING,
																...
																.addComponent(comboTipoAsignatura, 0, 268,
																		Short.MAX_VALUE)
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (arg0.getSource() == btnCrear) {
			...
			try {
				...
				JOptionPane.showMessageDialog(null, "Se creó correctamente la asignatura");
		...
		if (arg0.getSource() == brtnEditar) {
			...
			try {
				...
				JOptionPane.showMessageDialog(null, "Se editó correctamente la asignatura");
		...
		if (arg0.getSource() == btnBuscar) {
			...
			try {
				...
				Asignatura asig = controlador.buscar(codigo);
				...
				if (asig != null) {
					...
					tfSemestre.setText(asig.getSemestre() + "");

				} else {

					JOptionPane.showMessageDialog(null, "No se encontró la asignatura");
		...
		if (arg0.getSource() == btnEliminar) {
			...
			JOptionPane.showMessageDialog(null, "Se ha elimando la asignatura");
